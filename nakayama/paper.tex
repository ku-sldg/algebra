...
\emily[inline]{Emily:  Reflecting, I think it would be valuable to include at least parts of the formal proof.  Pieces would work, though it is short, and it could be ``broken up'' among the description of the informal argument.  As is, our description of the proof focuses on the informal argument, which is not ``new''. }
