...
\subsubsection{Ideals of commutative rings}
...
\subsubsection{Modules over commutative rings}
...
\emily[inline]{Emily: I changed statement to \emph{if and only if} below; do we need to update formal proof?}
...
\subsection{The Formal Statement of Nakayama's Lemma}
