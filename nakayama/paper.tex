...
\emily[inline]{Emily says:  There was an issue with our argument below, so I have updated it, and need to point to 
quotients to deal with the fact that we want a maximal ideal \emph{that contains a fixed element}.
}
