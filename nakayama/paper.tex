...
we formally prove \emph{Nakayama's lemma} \cite{nakayama-1951, azumaya}, a fundamental theorem in the field of commutative algebra, in Coq.  
...
%It is widely applied throughout algebra. %, true to the convention that ``lemma'' often refers to a result serving as a stepping stone toward another.  However, Nakayama's lemma 
