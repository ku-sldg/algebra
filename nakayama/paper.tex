...
\emily[inline]{It would be nice to differentiate between our structures that are typeclasses (e.g., {\tt Ideal}), and other definitions (e.g., {\tt maximal ideal})}
...
\emily[inline]{
We'll also need to update the code.  I think {\tt vectors} should be something like {\tt scalar-combinations}, and {\tt basis} something like {\tt generating-set}. 
}
